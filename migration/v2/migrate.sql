...
ALTER TABLE Allpays ADD COLUMN `EventOrderId` int (11) , ADD KEY ( `EventOrderId` );
ALTER TABLE Allpays CONSTRAINT `allpays_ibfk_2` FOREIGN KEY (`EventOrderId`) REFERENCES `EventOrders` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
